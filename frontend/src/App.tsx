...
const DEV_RPC_URL = typeof window === "undefined"
  ? "http://127.0.0.1:5173/rpc"
  : `${window.location.origin}/rpc`;
const RPC_URL = import.meta.env.VITE_CHAINPAY_RPC_URL ?? (import.meta.env.DEV ? DEV_RPC_URL : "https://api.devnet.solana.com");
...
const useCases = [
  { title: "AI accounting assistant", quote: "“Pay invoice #123 from our USDC treasury.”", detail: "ChainPay validates the invoice, checks spending policies, requests wallet approval, settles, and returns a receipt." },
  { title: "AI payroll agent", quote: "“It’s Friday. Pay 120 employees.”", detail: "Payroll limits, recipient lists, approval workflows, and settlement rules are enforced before funds move." },
  { title: "Robots and machines", quote: "A delivery robot pays a charging station or a taxi pays a toll.", detail: "The machine calls the ChainPay MCP instead of implementing wallets, token accounts, and settlement logic." },
  { title: "Customer support AI", quote: "“Refund this customer $45 in USDC.”", detail: "Support routes the refund through ChainPay instead of building a direct Stripe or blockchain integration." },
  { title: "Treasury AI", quote: "“Move $50,000 to the payroll wallet.”", detail: "Policies enforce approvals, daily limits, treasury rules, and business-hour controls." },
  { title: "AI shopping assistant", quote: "“Buy this software subscription.”", detail: "The agent retrieves the invoice and ChainPay routes it through the merchant’s supported connector." },
  { title: "Subscription manager", quote: "“Renew Copilot and cancel unused subscriptions.”", detail: "The agent finds invoices and ChainPay executes only payments covered by the approved policy." },
  { title: "Crypto commerce", quote: "A merchant accepts USDC at checkout.", detail: "The checkout calls ChainPay MCP instead of embedding custom Solana payment code." },
  { title: "Freelancer payouts", quote: "A client approves a cross-border payout.", detail: "The platform’s agent settles worldwide payouts through the same policy and receipt interface." },
  { title: "DAO operations", quote: "“Pay contributors after proposal #56 passed.”", detail: "The DAO agent checks governance state, then ChainPay settles once the policy conditions are satisfied." },
];
      ...
      <main id="top">
        <section className="hero page-width">
          <div className="hero-copy">
            ...
            <h1>The universal payment interface for <em>AI agents.</em></h1>
    ...
    <div className="dashboard-app">
      ...
      <div className="dashboard-layout">
        <aside className="dashboard-sidebar">
          ...
          <button className={tab === "assistant" ? "side-link active" : "side-link"} onClick={() => setTab("assistant")}><span>⌁</span> Agent assistant</button>
