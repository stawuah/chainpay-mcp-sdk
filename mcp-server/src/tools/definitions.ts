export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        resource: { type: "string", description: "The HTTPS x402-gated resource URL" },
        payer: { type: "string", description: "Connected wallet public address that owns the source token account" },
        paymentRequired: {
          type: "object",
          description: "The exact x402 v2 PAYMENT-REQUIRED object returned by the merchant",
          properties: {
        ...
        signingMode: { type: "string", enum: ["human"] },
      },
      required: ["resource", "payer", "paymentRequired"],
      additionalProperties: false,
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        payer: { type: "string", description: "Connected wallet public address that owns the source token account" },
        paymentRequired: { type: "object", description: "Required on the second call; pass the unchanged PAYMENT-REQUIRED returned on the first call" },
        signingMode: { type: "string", enum: ["human"] },
        signedTransaction: {
          type: "string",
